...
export function CampaignWizard() {
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="sticky bottom-0 z-20 -mx-4 flex items-center justify-between border-t border-border bg-card px-4 py-3 md:-mx-6 md:bg-background md:py-3 md:pr-24 md:pl-6">
