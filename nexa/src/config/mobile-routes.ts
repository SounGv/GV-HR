...
const EXACT: Record<string, MobileRouteMeta> = {
  ...
  "/meetings": { title: "นัดประชุม", backHref: "/services" },
  "/meetings/new": { title: "นัดประชุมใหม่", backHref: "/meetings" },
...
const PATTERNS: RoutePattern[] = [
  ...
  { pattern: /^\/meetings\/[^/]+$/, meta: { title: "รายละเอียดการประชุม", backHref: "/meetings" } },
